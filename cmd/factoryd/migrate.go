...
// old long-running status or health services were stopped after an install.
func runMigrate(args []string) int {
	...
	case "service-registry":
		...
		fmt.Fprintln(os.Stdout, "service registry ready; the operator attested that every pre-registry status and health service was stopped or restarted")
		return exitOK
	default:
		fmt.Fprintln(os.Stderr, "usage: factoryd migrate --config <f> <verdict-registry|service-registry>")
		return exitConfig
